...
Invoke-ProjectPython -m src.train --config configs/clean_ablation_5pct_no_dc.yaml --device cuda
Invoke-ProjectPython -m src.train --config configs/clean_ablation_5pct_no_null.yaml --device cuda
Invoke-ProjectPython -m src.train --config configs/clean_ablation_5pct_no_adv.yaml --device cuda
