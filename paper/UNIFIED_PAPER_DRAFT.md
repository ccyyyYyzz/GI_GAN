...
| Record consistency certifiable per mode | theorem | contraction; §3 |
| Prior supply preserves record consistency | theorem | Thm. 2; §4 |
| Balanced dial: perception up at bounded cost | locked experiment | 32.6%, 8/8; §4.3 |
| GT-free per-image adaptation adds little | development-level | $\le 0.002$; §4.5 |
| Published DL-GI gains: same ledger structure | external audit | 3 pipelines; §5 |
