...
\usepackage{parskip}
\title{Certify What You Measure: A Ground-Truth-Free Range--Null Audit for Learned Ghost and Single-Pixel Imaging}
\author{}\date{}
\begin{document}
\maketitle
...
\subsection*{2.1 Range--null geometry of the sensing operator}
...
\begin{enumerate}
\item T. B. Pittman, Y. H. Shih, D. V. Strekalov, and A. V. Sergienko, "Optical imaging by means of two-photon quantum entanglement," Phys. Rev. A \textbf{52}, R3429 (1995).
\item A. Gatti, E. Brambilla, M. Bache, and L. A. Lugiato, "Ghost imaging with thermal light: comparing entanglement and classical correlation," Phys. Rev. Lett. \textbf{93}, 093602 (2004).
\item J. H. Shapiro, "Computational ghost imaging," Phys. Rev. A \textbf{78}, 061802(R) (2008).
\item Y. Bromberg, O. Katz, and Y. Silberberg, "Ghost imaging with a single detector," Phys. Rev. A \textbf{79}, 053840 (2009).
\item M. F. Duarte, M. A. Davenport, D. Takhar, J. N. Laska, T. Sun, K. F. Kelly, and R. G. Baraniuk, "Single-pixel imaging via compressive sampling," IEEE Signal Process. Mag. \textbf{25}(2), 83--91 (2008).
\item M. P. Edgar, G. M. Gibson, and M. J. Padgett, "Principles and prospects for single-pixel imaging," Nat. Photonics \textbf{13}, 13--20 (2019).
\item P. Clemente, V. Durán, V. Torres-Company, E. Tajahuerce, and J. Lancis, "Optical encryption based on computational ghost imaging," Opt. Lett. \textbf{35}, 2391--2393 (2010).
\item W. Chen, "Ghost identification based on single-pixel imaging in big data environment," Opt. Express \textbf{25}, 16509--16516 (2017).
\item W. Jiao et al., "Single-pixel imaging: principles, methods, algorithms, and applications," Adv. Imaging (2026), doi:10.3788/AI.2026.20002.
\item M. Lyu, W. Wang, H. Wang, H. Wang, G. Li, N. Chen, and G. Situ, "Deep-learning-based ghost imaging," Sci. Rep. \textbf{7}, 17865 (2017).
\item Y. He, G. Wang, G. Dong, S. Zhu, H. Chen, A. Zhang, and Z. Xu, "Ghost imaging based on deep learning," Sci. Rep. \textbf{8}, 6469 (2018).
\item R. Shang, M. A. O'Brien, and G. P. Luke, "Deep-learning-driven reliable single-pixel imaging with uncertainty approximation," arXiv:2107.11678 (2021).
\item F. Wang, C. Wang, C. Deng, S. Han, and G. Situ, "Single-pixel imaging using physics enhanced deep learning," Photonics Res. \textbf{10}, 104--110 (2022).
\item F. Wang, C. Wang, M. Chen, W. Gong, Y. Zhang, S. Han, and G. Situ, "Far-field super-resolution ghost imaging with a deep neural network constraint," Light Sci. Appl. \textbf{11}, 1 (2022).
\item E. J. Candès, J. Romberg, and T. Tao, "Robust uncertainty principles: exact signal reconstruction from highly incomplete frequency information," IEEE Trans. Inf. Theory \textbf{52}, 489--509 (2006).
\item J. Zhang and B. Ghanem, "ISTA-Net: interpretable optimization-inspired deep network for image compressive sensing," in Proc. IEEE/CVF CVPR (2018), pp. 1828--1837.
\item J. Schwab, S. Antholzer, and M. Haltmeier, "Deep null space learning for inverse problems: convergence analysis and rates," Inverse Probl. \textbf{35}, 025008 (2019).
\item Y. Wang, J. Yu, and J. Zhang, "Zero-shot image restoration using denoising diffusion null-space model," in Proc. ICLR (2023), arXiv:2212.00490.
\item J. Wang, S. Wang, R. Zhang, Z. Zheng, W. Liu, and X. Wang, "A range-null space decomposition approach for fast and flexible spectral compressive imaging," arXiv:2305.09746 (2023).
\item P. C. Hansen, \textit{Rank-Deficient and Discrete Ill-Posed Problems} (SIAM, 1998).
\item Y. Cai, J. Lin, X. Hu, H. Wang, X. Yuan, Y. Zhang, R. Timofte, and L. Van Gool, "Mask-guided spectral-wise transformer for efficient hyperspectral image reconstruction," in Proc. IEEE/CVF CVPR (2022), pp. 17502--17511.
\item Z. Meng, J. Ma, and X. Yuan, "End-to-end low cost compressive spectral imaging with spatial-spectral self-attention," in Proc. ECCV, LNCS 12368 (Springer, 2020), pp. 187--204.
\item J. Zbontar, F. Knoll, A. Sriram, et al., "fastMRI: an open dataset and benchmarks for accelerated MRI," arXiv:1811.08839 (2018).
\item D. J. C. MacKay, "Bayesian interpolation," Neural Comput. \textbf{4}, 415--447 (1992).
\item R. Zhang, P. Isola, A. A. Efros, E. Shechtman, and O. Wang, "The unreasonable effectiveness of deep features as a perceptual metric," in Proc. IEEE/CVF CVPR (2018), pp. 586--595.
\end{enumerate}
