...
|---|---|---|---|---|
| PEDL [13] | simulated, noiseless | $9.9\times10^{-5}$ | $3.0\times10^{-3}$ | $96.8\%$ |
| Noise2Ghost | simulated, noisy | $1.1\times10^{-3}$ | $1.3\times10^{-2}$ | $92.7\%$ |
