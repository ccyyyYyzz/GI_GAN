...
output = Path(f"/content/gan_r56_heldout_recovery/lane{lane_index}")
...
command = [
    ...
    "--freeze-manifest",
    str(repo / "results/gan_gi_journal_round52/heldout_freeze_v2.json"),
    "--dataset-root",
    "/content/datasets",
    "--split",
    "test",
...
print("ROUND56_HELDOUT_RECOVERY_BACKGROUND_LAUNCHED", lane_index, output)
