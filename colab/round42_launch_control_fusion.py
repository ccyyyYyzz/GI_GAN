...
output = Path("/content/gan_r42_results/control_frequency_fusion")
...
command = [
    ...
    "/content/gan_r40_results/gan_r38_vqae/checkpoint_vqae_control_rot0.25_adv0.pt",
    "--top-exact",
    "12",
    "--batch-size",
    "32",
...
print("ROUND42_CONTROL_BACKGROUND_LAUNCHED", output)
